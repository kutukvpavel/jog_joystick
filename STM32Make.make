...
User/interrupt_callbacks.c \
User/ushell/src/sys_command_line.c \
User/ushell/src/sys_queue.c
...
GCC_PATH="/home/paul/.config/Code/User/globalStorage/bmd.stm32-for-vscode/@xpack-dev-tools/arm-none-eabi-gcc/12.3.1-1.2.1/.content/bin
ifdef GCC_PATH
...
ADDITIONALLDFLAGS = -Wl,--no-warn-rwx-segment -Wl,--print-memory-usage -Wl,--strip-debug -flto -specs=nano.specs -u _printf_float -u _scanf_float 
...
flash: $(BUILD_DIR)/$(TARGET).elf
	"/home/paul/.config/Code/User/globalStorage/bmd.stm32-for-vscode/@xpack-dev-tools/openocd/0.12.0-2.1/.content/bin/openocd" -f ./openocd.cfg -c "program $(BUILD_DIR)/$(TARGET).elf verify reset exit"

#######################################
# erase
#######################################
erase: $(BUILD_DIR)/$(TARGET).elf
	"/home/paul/.config/Code/User/globalStorage/bmd.stm32-for-vscode/@xpack-dev-tools/openocd/0.12.0-2.1/.content/bin/openocd" -f ./openocd.cfg -c "init; reset halt; stm32f1x mass_erase 0; exit"
